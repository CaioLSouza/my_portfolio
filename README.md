...
* **Modelo de valuation da Alupar (ALUP11):** DCF do fluxo ao acionista de uma transmissora de energia, montado em termos reais e inteiramente dirigido por fórmulas, com aba de premissas, aferição contra os números divulgados e análise de sensibilidade. Como a RAP é indexada ao IPCA, o modelo projeta em moeda constante e desconta a uma taxa real, o que torna a TIR resultante diretamente comparável com a NTN-B. [Link do projeto](https://github.com/CaioLSouza/my_portfolio/tree/main/alupar_valuation).

* **Boletim de Fundos de Investimento (ANBIMA/CVM):** script e workflow do GitHub Actions que baixam recorrentemente os dados diários de fundos de investimento (ICVM 555) que sustentam as estatísticas do Boletim de Fundos de Investimento da ANBIMA, usando o Portal de Dados Abertos da CVM como fonte gratuita. [Link do projeto](https://github.com/CaioLSouza/my_portfolio/tree/main/boletim_fundos_anbima).
