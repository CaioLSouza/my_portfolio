...
* **Tracker de Teleconferências de Resultados (IA):** usa o Claude (API da Anthropic) com saída estruturada para transformar transcrições de teleconferências de resultados em dados: tom da gestão, temas discutidos, mudanças de guidance e perguntas em que a gestão desviou, por empresa e trimestre, com agregação por setor e rascunho de relatório. [Link do projeto](https://github.com/CaioLSouza/my_portfolio/tree/main/tracker_teleconferencias).
